  ...
  return (
    ...
    >
      ...
      <div className="my-6 grid gap-4 sm:grid-cols-3">
        {finalidades.map((fn) => (
          <div key={fn.title} className="rounded-xl border border-crfal-gray-200 bg-crfal-gray-50 p-5 transition-colors hover:border-crfal-blue/25   ">
            ...
            <h3 className="mb-1.5 text-sm font-bold text-neutral-800 ">{fn.title}</h3>
            <p className="text-xs leading-relaxed text-crfal-gray-600 ">{fn.desc}</p>
          </div>
        ))}
      </div>
      ...
      <div className="mt-6 flex items-center gap-3 rounded-xl border border-crfal-blue/15 bg-crfal-blue-lighter/50 p-5  ">
        <BarChart3 className="h-5 w-5 shrink-0 text-crfal-blue " />

...
export default function RelatoriosFiscalizacaoPage() {
  return (
    ...
    >
      ...
      <ul>
        <li>Consolidar os resultados obtidos frente às metas do Plano de Fiscalização Anual.</li>
        <li>Permitir análise técnica de acertos, deficiências e dificuldades operacionais.</li>
        <li>Subsidiar ações corretivas e melhoria contínua dos atos de fiscalização.</li>
      </ul>

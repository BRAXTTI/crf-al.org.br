...
export default function FiscalizacaoPageShell({ title, description, children }: FiscalizacaoPageShellProps) {
  ...
  return (
    <>
      ...
      <div className="bg-crfal-gray-50 pb-16 dark:bg-slate-950 md:pb-24">
        <div className="container-crfal py-8 md:py-10">
          <div className="lg:hidden mb-8">
            <button
              onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
              className="flex w-full items-center justify-between rounded-xl border border-crfal-gray-200 bg-white px-5 py-3.5 text-sm font-semibold text-neutral-800 shadow-sm transition-colors hover:bg-crfal-gray-50 dark:border-slate-700 dark:bg-slate-900 dark:text-white dark:hover:bg-slate-800"
            ...
            <div className={`overflow-hidden transition-all duration-300 ${mobileMenuOpen ? 'mt-3 max-h-[600px] opacity-100' : 'max-h-0 mt-0 opacity-0'}`}>
              <div className="grid grid-cols-1 gap-1.5 rounded-xl border border-crfal-gray-200 bg-white p-2 shadow-sm dark:border-slate-700 dark:bg-slate-900 sm:grid-cols-2">
                {quickLinks.map((item) => {
                  ...
                  const linkClass = `flex items-center justify-between rounded-lg px-4 py-2.5 text-sm font-medium transition-all ${
                    isActive
                      ...
                      : 'text-neutral-700 hover:bg-crfal-gray-100 dark:text-slate-200 dark:hover:bg-slate-800'
                  }`;
          ...
          <div className="grid gap-8 lg:grid-cols-12">
            ...
            <aside className="hidden lg:col-span-4 lg:block">
              <div className="sticky top-28 space-y-5">
                <nav className="rounded-xl border border-crfal-gray-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                ...
                <div className="rounded-xl border border-crfal-blue/20 bg-gradient-to-br from-crfal-blue/8 to-white p-5 dark:border-crfal-blue/30 dark:from-crfal-blue/10 dark:to-slate-900">
                  ...
                  <p className="mb-4 text-sm leading-relaxed text-crfal-gray-600 dark:text-slate-300">

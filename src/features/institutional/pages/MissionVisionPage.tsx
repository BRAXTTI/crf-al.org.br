  ...
  return (
    <div className="min-h-screen bg-crfal-gray-50 ">
      ...
      <div className="container-crfal py-10 md:py-16" ref={sectionRef}>
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {secoes.map((secao, index) => {
            ...
            return (
              <div
                key={secao.id}
                className={`group bg-white  rounded-xl border border-crfal-gray-200  overflow-hidden transition-all duration-500 hover:shadow-card hover:border-crfal-blue/20 hover:-translate-y-1 ${
              ...
              >
                ...
                <div className="p-6">
                  <p className="text-crfal-gray-600  leading-relaxed">{secao.descricao}</p>
                </div>
              </div>
            );
          })}
        ...
        <div
          className={`mt-12 bg-crfal-blue-lighter  rounded-xl border border-crfal-blue/10  p-6 md:p-8 transition-all duration-700 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}

    ...
    items: [
      {
        ...
        description: 'Solicite sua primeira inscrição no Conselho Regional de Farmácia de Alagoas.',
        documentos: [
      ...
      },
      {
        ...
        description: 'Transfira sua inscrição de outro CRF para o CRF de Alagoas.',
        documentos: [
      ...
      },
      {
        ...
        description: 'Obtenha inscrição secundária para atuar em mais de uma jurisdição.',
        documentos: [
    ...
    items: [
      {
        ...
        description: 'Solicite certidão comprovando sua regularidade perante o CRFAL.',
        documentos: [
      ...
      },
      {
        ...
        description: 'Solicite a segunda via da sua carteira profissional em caso de perda, roubo ou dano.',
        documentos: [
    ...
    items: [
      {
        ...
        description: 'Atualize seus dados pessoais como nome, endereço, telefone e e-mail.',
        documentos: [
    ...
    items: [
      {
        ...
        description: 'Registre seu estabelecimento farmacêutico junto ao CRFAL.',
        documentos: [
      ...
      },
      {
        ...
        description: 'Solicite a autorização de funcionamento para seu estabelecimento.',
        documentos: [
    ...
    items: [
      {
        ...
        description: 'Registre ou altere o vínculo de responsabilidade técnica do estabelecimento.',
        documentos: [
      ...
      },
      {
        ...
        description: 'Solicite a baixa do vínculo de responsabilidade técnica.',
        documentos: [
    ...
    items: [
      {
        ...
        description: 'Emita a certidão de regularidade do estabelecimento perante o CRFAL.',
        documentos: [
      ...
      },
      {
        ...
        description: 'Atualize os dados cadastrais do estabelecimento como endereço, razão social ou sócios.',
        documentos: [

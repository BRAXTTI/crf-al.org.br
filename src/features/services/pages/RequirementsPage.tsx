    ...
    items: [
      {
        ...
        instrucoes: [
          'Acesse o CRF-AL em Casa para iniciar o serviço.',
          'Preencha os dados solicitados no portal.',
          'Separe os documentos obrigatórios conforme lista oficial.',
          'Entregue os itens físicos exigidos na sede/seccional quando aplicável.',
          'Acompanhe o andamento no canal oficial.',
        ],
    ...
    items: [
      {
        ...
        instrucoes: [
          ...
          'Anexe os documentos listados no formulário oficial.',
          'Protocole no CRF-AL.',
        ],
        prazo: 'Conforme análise do CRF-AL',
        downloadUrl: 'https://www.crf-al.org.br/requerimentos/',
    ...
    items: [
      {
        ...
        instrucoes: [
          ...
          'Protocole no CRF-AL e aguarde instruções complementares.',
        ],
        prazo: 'Conforme análise do CRF-AL',
        downloadUrl: 'https://www.crf-al.org.br/requerimentos/',
      },
    ...
    items: [
      {
        ...
        instrucoes: [
          ...
          'Protocole pelo canal oficial do CRF-AL.',
      ...
      },
      {
        ...
        instrucoes: [
          ...
          'Protocole no CRF-AL e acompanhe análise técnica.',

      ...
      <main className="container-crfal py-10 md:py-14">
        ...
        <section className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
          <div className="animate-in fade-in slide-in-from-bottom-3 fill-mode-backwards duration-500">
            <span className="mb-3 inline-block rounded-full bg-crfal-blue-lighter px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-crfal-blue  ">
              Atendimento
            </span>
            <h2 className="mb-4 font-display text-2xl font-bold text-neutral-800  sm:text-3xl">
              Como nossa Ouvidoria funciona
            </h2>
            <div className="space-y-4 text-sm leading-relaxed text-crfal-gray-600  sm:text-base">
              <p>
                O atendimento é realizado pelo{' '}
                <strong className="font-semibold text-crfal-blue ">
          ...
          <div
            className="animate-in fade-in slide-in-from-bottom-3 fill-mode-backwards rounded-2xl border border-crfal-blue/15 bg-white p-7 shadow-card duration-500   sm:p-8"
            style={{ animationDelay: '120ms' }}
          >
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-crfal-blue text-white">
              <ExternalLink className="h-6 w-6" />
            </div>
            <h3 className="mb-2 font-display text-lg font-semibold text-neutral-800  sm:text-xl">
              Portal da Transparência — Implanta
            </h3>
            <p className="mb-6 text-sm leading-relaxed text-crfal-gray-600 ">
        ...
        <section className="mt-14 md:mt-20">
          <div className="mb-8 text-center">
            <h2 className="mb-3 font-display text-2xl font-bold text-neutral-800  sm:text-3xl">
              Escolha o tipo de manifestação
            </h2>
            <p className="mx-auto max-w-2xl text-sm leading-relaxed text-crfal-gray-600  sm:text-base">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {manifestationTypes.map((type) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex flex-col rounded-2xl border border-crfal-gray-200 bg-white p-6 shadow-card transition-all duration-300 hover:-translate-y-1.5 hover:border-crfal-blue/30 hover:shadow-card-hover   "
              >
                <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-crfal-blue-lighter text-crfal-blue transition-colors duration-300 group-hover:bg-crfal-blue group-hover:text-white  ">
                  <type.icon className="h-5 w-5" />
                </div>
                <h3 className="mb-2 flex items-center gap-2 font-display text-base font-semibold text-neutral-800 ">
                  {type.label}
        ...
        <section className="mt-14 md:mt-20">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {dataTreatment.map((item) => (
              <div
                key={item.title}
                className="rounded-2xl border border-crfal-gray-200 bg-white p-6 shadow-card  "
              >
          ...
          <div className="mt-6 rounded-2xl border border-crfal-blue/15 bg-crfal-blue-lighter/50 p-6  ">
            <p className="text-sm leading-relaxed text-crfal-gray-600 ">
              ...
              <a
                ...
                className="font-semibold text-crfal-blue hover:underline "
              >
        ...
        {/* FAQ */}
        <section className="mt-14 md:mt-20">
          <h2 className="mb-6 flex items-center gap-2 font-display text-xl font-semibold text-neutral-800  md:text-2xl">
            <HelpCircle className="h-5 w-5 text-crfal-blue " />
              ...
              return (
                <div
                  ...
                  className={`overflow-hidden rounded-xl border transition-colors ${
                    aberta
                      ? 'border-crfal-blue/30 bg-crfal-blue-lighter/40  '
                      : 'border-crfal-gray-200 bg-white  '
                  }`}
                >
                  <button
                    onClick={() => setFaqAberta(aberta ? null : index)}
                    aria-expanded={aberta}
                    className="flex w-full items-center justify-between gap-3 px-4 py-3.5 text-left text-sm font-semibold text-neutral-800 transition-colors hover:text-crfal-blue focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-crfal-blue-light  "
                  >
                    {faq.q}
                    <ChevronDown className={`h-4 w-4 shrink-0 text-crfal-gray-400 transition-transform duration-300 ${aberta ? 'rotate-180 text-crfal-blue ' : ''}`} />
                  </button>
                  <div className={`grid transition-all duration-300 ease-out ${aberta ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
                    <div className="overflow-hidden">
                      <p className="px-4 pb-4 text-sm leading-relaxed text-crfal-gray-600 ">{faq.a}</p>
                    </div>
                  </div>
                </div>
              );

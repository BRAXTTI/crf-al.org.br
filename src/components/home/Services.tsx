                      ...
                      >
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <h3 className="text-lg sm:text-xl font-bold text-white leading-snug">{service.title}</h3>
                        ...
                        <ol className="space-y-2.5 sm:space-y-3">
                          {service.tutorial.steps.map((step, stepIndex) => (
                            <li key={stepIndex} className="flex items-start gap-3">
                              ...
                              <span className="text-sm text-neutral-700 dark:text-slate-300 leading-relaxed pt-1">{step}</span>
                            </li>
                          ))}
                        </ol>
                      </div>

  ...
  return (
    <section className="relative w-full h-[500px] md:h-[600px] overflow-hidden bg-crfal-gray">
              ...
              <div className="relative z-10 h-full flex items-center">
                <div className="container-crfal">
                  <div className="max-w-2xl">
                    ...
                    <a
                      href={slide.href}
                      className={`inline-flex items-center gap-2 px-8 py-4 bg-white text-crfal-blue font-semibold rounded-lg hover:bg-crfal-blue-lighter dark:!bg-blue-100 dark:!text-slate-900 dark:hover:!bg-blue-50 transition-all duration-500 hover:-translate-y-1 hover:shadow-lg ${
                        isActive
                          ? 'opacity-100 translate-y-0'
                          : 'opacity-0 translate-y-8'
                      }`}
      ...
      <button
        ...
        className="absolute left-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 bg-white/90 hover:bg-white dark:bg-slate-100/95 dark:hover:bg-slate-200 rounded-full flex items-center justify-center text-crfal-blue dark:!text-slate-900 shadow-lg transition-all duration-300 hover:scale-110 disabled:opacity-50"
      ...
      <button
        onClick={nextSlide}
        disabled={isAnimating}
        className="absolute right-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 bg-white/90 hover:bg-white dark:bg-slate-100/95 dark:hover:bg-slate-200 rounded-full flex items-center justify-center text-crfal-blue dark:!text-slate-900 shadow-lg transition-all duration-300 hover:scale-110 disabled:opacity-50"
